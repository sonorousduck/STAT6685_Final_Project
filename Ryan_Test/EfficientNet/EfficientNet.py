...
for i in range(fold):
  ...
  np.savetxt('train_epoch_losses_efficient_net.txt', train_epoch_losses, delimiter=',')
  np.savetxt('valid_epoch_losses_efficient_net.txt', valid_epoch_losses, delimiter=',')
  np.savetxt('valid_epoch_accuracy_efficient_net.txt', valid_epoch_accuracy, delimiter=',')
  np.savetxt('valid_epoch_f1_efficient_net.txt', valid_epoch_f1, delimiter=',')
  np.savetxt('test_loss_accuracy_f1_efficient_net.txt', np.array([test_loss, test_accuracy, test_f1]))