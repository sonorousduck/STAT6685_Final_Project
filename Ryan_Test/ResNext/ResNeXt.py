...
for i in range(fold):
  ...
  np.savetxt('train_epoch_losses_resnext.txt', train_epoch_losses, delimiter=',')
  np.savetxt('valid_epoch_losses_resnext.txt', valid_epoch_losses, delimiter=',')
  np.savetxt('valid_epoch_accuracy_resnext.txt', valid_epoch_accuracy, delimiter=',')
  np.savetxt('valid_epoch_f1_resnext_no_data.txt', valid_epoch_f1, delimiter=',')
  np.savetxt('test_loss_accuracy_f1_resnext.txt', np.array([test_loss, test_accuracy, test_f1]), delimiter=",")