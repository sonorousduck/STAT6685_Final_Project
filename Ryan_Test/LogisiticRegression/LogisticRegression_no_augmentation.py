...
if __name__ == "__main__":
    ...
    plt.suptitle(f"Logistic Regression No Augmentation")
    ...
    plt.savefig(f'./logistic_regression_no_augmentation.jpg')
    ...
    np.savetxt('train_epoch_losses_logistic_regression_no_augmentation.txt', train_losses, delimiter=',')
    np.savetxt('valid_epoch_losses_logistic_regression_no_augmentation.txt', valid_losses, delimiter=',')
    np.savetxt('valid_epoch_accuracy_logistic_regression_no_augmentation.txt', valid_accuracies, delimiter=',')
    np.savetxt('valid_epoch_f1_logistic_regression_no_augmentation.txt', valid_epoch_f1, delimiter=',')
    np.savetxt('test_loss_accuracy_f1_logistic_regression_no_augmentation.txt', np.array([test_loss, test_accuracy, test_f1]))
