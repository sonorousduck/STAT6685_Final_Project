...
def run(fold):
  ...
  if load:
    regnet.load_state_dict(torch.load('./regnet_no_augmentation_class_imbalance_frozen.bin'))
  ...
  for epoch in range(epochs):
    ...
    if (last_accuracy < valid_accuracy):
        ...
        torch.save(regnet.state_dict(), f'./regnet_no_augmentation_class_imbalance_frozen.bin')
        early_stop = 10
    else:
      early_stop -= 1
...
for i in range(fold):
  ...
  plt.suptitle(f"RegNet No Augmentation Less Class Imbalance Not Frozen")
  ...
  plt.savefig(f'./regnet_no_augmentation_class_imbalance_frozen.jpg')
  ...
  np.savetxt('train_epoch_losses_regnet_no_augmentation_class_imbalance_frozen.txt', train_epoch_losses, delimiter=',')
  np.savetxt('valid_epoch_losses_regnet_no_augmentation_class_imbalance_frozen.txt', valid_epoch_losses, delimiter=',')
  np.savetxt('valid_epoch_accuracy_regnet_no_augmentation_class_imbalance_frozen.txt', valid_epoch_accuracy, delimiter=',')
  np.savetxt('valid_epoch_f1_regnet_no_augmentation_class_imbalance_frozen.txt', valid_epoch_f1, delimiter=',')
  np.savetxt('test_loss_accuracy_f1_regnet_no_augmentation_class_imbalance_frozen.txt', np.array([test_loss, test_accuracy, test_f1]))
